<template>
  <div class="py-8 px-4 sm:px-8 md:px-12 lg:px-28 lg:py-32 lg:flex justify-between items-center bg-blue-100">
    <img class="w-full lg:w-1/2 h-[720px] lg:h-[640px]" src="https://images.unsplash.com/photo-1514222709107-a180c68d72b4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=900&q=80" alt="people working - about us">
