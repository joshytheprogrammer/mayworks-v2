<template>
  <div id="about" class="py-8 px-4 sm:px-8 md:px-12 lg:px-28 lg:py-32 lg:flex justify-between items-center bg-blue-100">
    <img class="w-full lg:w-1/2 h-[540px] lg:h-[640px]" src="https://images.unsplash.com/photo-1514222709107-a180c68d72b4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=900&q=80" alt="people working - about us">
    <div class="lg:w-1/2 lg:pl-8">
      <h2 class="py-4 font-medium text-blue-900 ">ABOUT US</h2>
      ...
      <div class="flex text-white">
        <button class="mr-4 px-8 py-4 bg-gradient-to-l hover:bg-gradient-to-r from-blue-700 to-blue-900">Discover More</button>
